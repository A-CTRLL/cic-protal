          ...
          <Card>
              ...
              <div className='flex items-center gap-2'>
                 <IoConstructSharp className='text-3xl'/>
                  <h3 className='text-md leading-none'>Company Registration</h3>
              </div>
          </Card>
          <Card>
              <span className='text-5xl font-bold text-center'>234</span>
              <div className='flex items-center gap-2'>
                 <IoDocumentText className='text-3xl'/>
                  <h3 className='text-md leading-none'>Projects Registered</h3>
              </div>
          </Card>
          <Card>
              <span className='text-5xl font-bold text-center'>1M SZL</span>
              <div className='flex items-center gap-2'>
                 <GiWallet className='text-3xl'/>
                  <h3 className='text-md leading-none'>Levies Collected</h3>
              </div>
          </Card>
          <Card>
              <span className='text-5xl font-bold text-center'>245k SZL</span>
              <div className='flex items-center gap-2'>
                 <PiCoinsFill className='text-3xl'/>
                  <h3 className='text-md leading-none'>Levies Outstanding</h3>
              </div>
          </Card>
      </section>
          ...
          <Card>  
              ...
              <div className='flex items-center gap-2'>
                 <MdMapsHomeWork className='text-3xl'/>
                  <h3 className='text-sm leading-none '>Work Discipline <br/>Management</h3>
              </div>
              <Button className='self-end mt-4'>View</Button>
              </div>
          </Card>         
      ...
      <Table>
        ...
        <TableHeader>
          <TableRow>
            ...
            <TableHead>Project Funder</TableHead>
          ...
          
            {
              projects.filter((project: any) => project.company_id === 1).map((project) => (
                <TableRow key={project.project_id} className='cursor-pointer'>
                  ...
                  <TableCell>{project.project_funder}</TableCell>
                  <TableCell>{project.bid_reference}</TableCell>
